...
$(function() {
    ...
    */
    ...
    describe('Initial Entries', function() {
        ...
        it('loadFeed not empty', function(done) {
    ...
    describe('New Feed Selection', function() {
         ...
         */
        var entryBeforeChange,
            entryAfterChange;
    //before All called once before all the specs in describe are run
        beforeAll(function (done) {
            entryBeforeChange = $('.feed a').children('.entry');
        ...
        it('new feed loaded - content changes', function (done) {
            ...
            expect(entryBeforeChange).not.toBe(entryAfterChange);
            done();
        });
